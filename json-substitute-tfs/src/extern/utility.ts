...
var zipUtility = require('./ziputility');
/**
 ...
 */
export function fileExists(path: any): boolean {
  try  {
 ...
 */
export function copySetParamFileIfItExists(setParametersFile: string | undefined) : string | undefined{
...
export function findfiles(filepath: any){
    ...
    if (filepath.indexOf('*') == -1 && filepath.indexOf('?') == -1) {
        ...
        var firstWildcardIndex = function(str: any) {
            var idx = str.indexOf('*');
...
export function generateTemporaryFolderOrZipPath(folderPath: string, isFolder: boolean): any {
